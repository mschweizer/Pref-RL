...
def main():
    ...
    agent = factory.create_agent(env=env, reward_model_name="Mlp", ensemble=False, active_selecting=False)

    agent.pb_learn(num_training_timesteps=6e5, num_training_preferences=500, num_pretraining_preferences=256)
