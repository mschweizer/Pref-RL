...
class PbRLAgentAssembler:
    ...
    @staticmethod
    def assemble_agent(env, reward_model_name, agent_factory: PbRLAgentFactory,
                       num_pretraining_epochs, num_training_iteration_epochs) -> PbRLAgent:
        ...
        return PbRLAgent(policy_model, pretraining_query_generator, query_generator, preference_querent,
                         ...
                         num_pretraining_epochs, num_training_iteration_epochs)
