...
def test_buffers_rewards(cartpole_env):
    ...
    standardization_wrapper = RewardStandardizationWrapper(cartpole_env)
...
def test_standardizes_reward():
    ...
    standardization_wrapper = RewardStandardizationWrapper(env=Mock(step=step_function_mock),
