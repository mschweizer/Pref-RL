...
from preference_collector.synthetic_preference.preference_oracle import RewardMaximizingOracleMixin, \
...
def test_reward_maximizing_oracle_prefers_higher_reward():
    ...
    assert RewardMaximizingOracleMixin().answer(query=[segment_1, segment_2]) == BinaryChoice.RIGHT
