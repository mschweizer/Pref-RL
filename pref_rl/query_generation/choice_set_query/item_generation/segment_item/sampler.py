...
from ..generator import AbstractQueryItemGenerator
from .common.random_no_env_reset_sampling import RandomNoEnvResetSamplingMixin
from .common.random_sampling import RandomSamplingMixin
from .....utils.logging import create_logger

SAMPLING_FAILURE_WARNING_MSG_1 = "Trajectory segment sampling failed. "
...
class AbstractSegmentSampler(AbstractQueryItemGenerator, ABC):
    ...
    def generate(self, policy_model, num_items):
        try:
            ...
            self.logger.warning(
                SAMPLING_FAILURE_WARNING_MSG_1 + str(e) + " Returning empty set of samples.")
            return []
...
class RandomNoEnvResetSegmentSampler(RandomNoEnvResetSamplingMixin, AbstractSegmentSampler):
    def __init__(self, segment_length):
        super().__init__(segment_length)
