...
class PbStepCallback(BaseCallback):
    ...
    def __init__(self, pb_step_function, pb_step_freq, query_candidates_factor, verbose=1):
        ...
        self.query_candidates_factor=query_candidates_factor
    ...
    def _on_rollout_end(self) -> None:
        if self._is_pb_step():
            self._pb_step_fn(self._num_timesteps_in_this_run(), self.query_candidates_factor)
